...
<html>
	...
	<body>
		...
		<div class="fixed-head">
			<h1 class="text-light">编辑${entity.tableComment!''}</h1>
				...
				<#list propertyList as property>
                    ...
                    <tr>
						...
						<td><input class="form-control" type="text" id="${property.propertyName}" name="${property.propertyName}" value="{{val.${property.propertyName}}}"></td>
							<#else>
						<td><textarea rows="10" style="width:100%;">{{val.${property.propertyName}}}</textarea></td>
							</#if>
