...
import com.github.rogerli.utils.exception.InstantiationException;
import com.github.rogerli.utils.exception.UnknownClassException;
...
/**
 * Utility method library used to conveniently interact with <code>Class</code>
 * es, such as acquiring them from the application <code>ClassLoader</code>s and
 * instantiating Objects from them.
 * 
 * @since 0.1
 */
