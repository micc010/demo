/**
 * @文件名称： RedisMybatisConfigurationBuilder.java
 * @文件描述：
 * @版权所有：(C)2016-2028
 * @公司：
 * @完成日期: 2016/12/22
 ...
 */
public class RedisMybatisConfigurationBuilder {

    /**
     * This class instance.
     */
    private static final RedisMybatisConfigurationBuilder INSTANCE = new RedisMybatisConfigurationBuilder();
     ...
     */
    private RedisMybatisConfigurationBuilder() {
     ...
     * @return this class instance.
     */
    public static RedisMybatisConfigurationBuilder getInstance() {
        return INSTANCE;
    }
     ...
     * Parses the Config and builds a new {@link ConfigWithHost}.
     *
     * @param    {@link ClassLoader} used to load the
